...
function init() {
  document.querySelector(".makeDiv").addEventListener("click", function() {
    ...
    newElement.innerHTML = `<p>Generated Div and P</p>`
    newElement.id = "new-element"

    let newElementWithNoId = document.createElement("div")
    newElementWithNoId.innerHTML = `<p>Generated Div and P 2</p>`
    ...
    newElement2.innerHTML = `<p>Generated Div and P 2</p>`
  ...
  document.querySelector('[data-test-foo2="baa"]').addEventListener("click", function() {
    ...
    newElementWithDataTest.innerHTML = `<p>Generated Div with data-test attr</p>`
  ...
  document.querySelector("#removeDiv").addEventListener("click", function() {
    ...
    if (existingEl) {
      document
        .querySelector("#buttonClickMutation")
        .removeChild(document.querySelector("#new-element"))
    }
  })
