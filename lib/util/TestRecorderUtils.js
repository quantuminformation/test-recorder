...
export default {
  ...
  setupAll: function (rootDomNode, codeOutputDiv) {
    ...
    mutationUtils.addObserverForTarget(rootDomNode, common.currentCodeGenerator);
    this.setGeneratedScript(common.currentCodeGenerator.initialCode());
  },
...
//todo native history/hashchange watching
  ...
  setUpClickListeners: function () {
    ...
    document.addEventListener('click', (e)=> {
      ...
      var cleanText = self.generatedTestCode.replace(common.MUTATIONS_PLACEHOLDER, "");
